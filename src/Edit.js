...
const Edit = ({ projectid, onCancel }) => {
  return (
    <div className="class4">
        ...
        <hr />
            <div className="items">
                <img className="hiksche" src={one} alt="editicon" />
                <p className="inf" >Edit project name</p>
            </div>
            <hr />
            <div className="items">
                <img className="hiksche" src={two} alt="editusericon" />
                <p className="inf" >Invite user</p>
            </div>
            <hr />
            <div className="items">
                <img className="hiksche" src={three} alt="deleteicon" />
                <p className="inf" >Delete project</p>
            </div>
            <hr />
            <p className="linkowe2" onClick={onCancel}>open other project</p>
    </div>
  );
}
